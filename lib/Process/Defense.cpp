...
// int Defense::go_flag = 0;
// int Defense::line_azimuth = 0;
// int Defense::line_stat = 0;
// int Defense::go_border[2] = {0, 0};
// int Defense::ball_azimuth = 0;
// int Defense::ball_stat = 0;
// int Defense::r_azimuth = 0;
// int Defense::line_ang = 0;
// int Defense::ball_ang = 0;
// int Defense::move_ang = 0;
// int Defense::lastdetect = 0;
// int Defense::calb = 0;
...
//         if(go_border[0] > go_border[1]) {
//             mypixel.angle_range(go_border[0]+calb, go_border[1]+calb, 0, 255, 0);
//         } else {
//             mypixel.angle_range(go_border[1]+calb, go_border[0]+calb, 0, 255, 0);
//         }
//         // go_angに向かって移動
//         norm360P(go_ang);
...
//         mybuzzer.stop();
//         lastdetect = line_azimuth;
//         if(isFront(line_azimuth)) {//問題の原因ここかもしれない
//             go_border[0] = line_azimuth-90;
//             go_border[1] = norm360(line_azimuth + 90);
//         } else {
//             go_border[0] = norm360(line_azimuth - 90); //-かも
//             go_border[1] = line_azimuth+180;
//         }
//         to_range(ball_azimuth, go_border[1], false);
...
//             mypixel.angle_range(go_border[1]+calb, go_border[0]+calb, 0, 255, 0);
//         }
//         mypixel.closest(go_border[0], 255, 255, 255 , 1);
//         mypixel.closest(go_border[1], 255, 255, 255 , 1);
//         mypixel.closest(ball_azimuth, 255, 100, 100 , 1);
//         mypixel.closest(go_ang, 57, 197, 187 , 1);
//     } else if(frog == FROG::NO_LINE) {
//         mymotor.run(lastdetect, return_power, 0);
//     } else if(frog == FROG::NO_BALL) {
//         mymotor.free();
