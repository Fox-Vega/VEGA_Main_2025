...
class MyVECTOR {
    public:
        ...
        void get_tarcord(int old_tar_azimuth, int old_tar_magnitude, int tar_azimuth, int tar_magnitude); //targetのコート座標を計算する関数　実行前に座標更新
        ...
        int get_tarsvecmagnitude(); //targetのコート基準速度ベクトルの大きさを返す関数
