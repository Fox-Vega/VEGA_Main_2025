...
class MyVECTOR {
    public:
        ...
        void get_tarsvec(int tar_azimuth, int tar_magnitude, int memoryNUM); //targetの速度ベクトルを計算する関数　自機基準座標を入力　実行前に座標更新　ボールの追跡にはメモリ0を使用
    ...
    private:
        ...
        int old_tarcord_x[1], old_tarcord_y[1];
        int svec_x, svec_y;
